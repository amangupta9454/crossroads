                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        <div className="form-section grid grid-cols-1 md:grid-cols-2 gap-10">
                            {[
                                ...
                                <div
                                    ...
                                    onMouseEnter={() => gsap.to(`#${field.name}`, { y: -8, scale: 1.02, duration: 0.4 })}
                                    onMouseLeave={() => gsap.to(`#${field.name}`, { y: 0, scale: 1, duration: 0.4 })}
                                >
                        ...
                        <div className="text-center">
                            <button
                                ...
                                onMouseEnter={() => gsap.to(buttonRef.current, { scale: 1.15, boxShadow: "0 0 25px rgba(147, 51, 234, 0.8)", duration: 0.3 })}
                                onMouseLeave={() => gsap.to(buttonRef.current, { scale: 1, boxShadow: "0 0 20px rgba(147, 51, 234, 0.5)", duration: 0.3 })}
                                onMouseDown={() => gsap.to(buttonRef.current, { scale: 0.9, duration: 0.2 })}
                                onMouseUp={() => gsap.to(buttonRef.current, { scale: 1.15, duration: 0.2 })}
                            >
